...
- :white_circle: *Поиск работы c пустым полем поиска и сортировкой*
- :white_circle: *Поиск работы с заполнением поля поиска и пустой сортировкой*
- :white_circle: *Поиск работы с заполнением поля поиска и сортировки*
- :white_circle: *Поиск работы c пустым полем и заполненной сортировкой*
- :white_circle: *Поиск работы с заполнением поля поиска и сортировки с последующим сбросом сортировки*

## <a name="Примеры ручных тест-кейсов">**Примеры ручных тест-кейсов:**</a>
- :white_circle: *Смена языка интерфейса с русского на английский*
- :white_circle: *Смена языка публикаций с русского на английский*
- :white_circle: *Смена вида ленты с классического на компактный*
- :white_circle: *Переход с ХабрКарьера на Хабр*
- :white_circle: *Переход с ХабрКарьера на Q&A*
- :white_circle: *Переход с ХабрКарьера на Фриланс*
- :white_circle: *Переход с ХабрКарьера на Анонимный Дед Мороз*
